...
// ─── Legacy static palette colours ────────────────────────────────────────────
// These were used by the old hand-authored lightColorScheme/darkColorScheme.
// The M3 Expressive theme now derives all colour roles dynamically from a seed
// via MaterialColorUtilities, so these constants are no longer wired into the
// theme. Kept here as a reference / fallback seed option.
